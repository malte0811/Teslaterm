...
export class CommandIPC {
    constructor(processIPC: MultiWindowIPC) {
        ...
        processIPC.onAsync(
            IPC_CONSTANTS_TO_MAIN.commands.setBusState,
            ($, enable) => setBoolOption(BoolOptionCommand.bus, enable),
        );
        processIPC.onAsync(
            IPC_CONSTANTS_TO_MAIN.commands.setKillState,
            ($, enable) => setBoolOption(BoolOptionCommand.kill, enable),
        );
        processIPC.onAsync(
